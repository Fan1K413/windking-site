...
推荐使用自动安装方式，它会自动下载对应版本、加载器与服务器需要的模组。
...
整合包会自动包含常用依赖。手动配置时，请确认 Minecraft、Fabric 和模组版本一致；可参考 [Fabric 安装文档](https://docs.fabricmc.net/players/installing-fabric/)、[Fabric API](https://modrinth.com/mod/fabric-api) 和 [Simple Voice Chat](https://modrinth.com/plugin/simple-voice-chat)。
